...
# Title: Top Block
# Generated: Thu Nov  7 15:18:00 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, .063, (rrc_taps), nfilts, nfilts/2, 1.5, 1)
        self.digital_lms_dd_equalizer_cc_0_0 = digital.lms_dd_equalizer_cc(8, .01, 1, BPSK)
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -4E3, 1, 0)
        ...
        self.connect((self.audio_source_0_0, 0), (self.blocks_float_to_complex_0_0, 0))
        self.connect((self.audio_source_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.blocks_multiply_xx_0_0_0, 0))
        ...
        self.connect((self.digital_diff_decoder_bb_0_0, 0), (self.blks2_packet_decoder_0_0, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0, 0), (self.blocks_complex_to_real_0_0, 0))
        self.connect((self.digital_lms_dd_equalizer_cc_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 1.6E3, .6E3, firdes.WIN_HAMMING, 6.76))
